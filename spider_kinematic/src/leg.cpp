...
//leg parts sizes
static const double cLegPart=53;
static const double bLegPart=81;
static const double aLegPart=120;
...
void Leg::RecalcAngles()
{
    ...
    m_servoManager.setAngleF(indexes_[0], angleA_);
    m_servoManager.setAngleF(indexes_[1], 180 - angleB_);
    m_servoManager.setAngleF(indexes_[2], angleC_ - angleCOffsetAccordingToLegAttachment_);
...
void Leg::SetMotorAngle(int idx, int angle)
{
    ...
    {
    case 0:
        m_servoManager.setAngleF(indexes_[0], angle);
        break;
    case 1:
        m_servoManager.setAngleF(indexes_[1],180 -angle);
        break;
    case 2:
        m_servoManager.setAngleF(indexes_[2],angle-angleCOffsetAccordingToLegAttachment_);
        break;
    }
}
